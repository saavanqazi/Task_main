...
| 5 | v6 | stacked: (1) 58 decisions on 45 edits in 30 wordings incl. "Ditto." ×6, "Same call as ED-xx." ×4, "As Ines had it.", "Take it, at the number Ines had."; no confirming helper; (2) the reference's ledger trap: 41 flags in flagging order with `position`, second-read flags appended, PS-16 in two stretches (24 + 9) with the second near the bottom; 40 passages; 9 trap checks, 13 checks | pending (`b52a9-glm5x-run6`) | |

Gold v6: 12 straddling / 7 deferred / 1 floored / 20 wholly / final page 18 (539 lines). Local: derive_gold clean
(every Log wording declared in DECISIONS; Not in asserted; stretch adjacency asserted), discrimination 50/50 (18 readings
distinct), oracle 1.0, nop 0.0, symlinks 0.0, planted hooks 0.0, extra key 0.923077.
The fixture is generated by `tools/build_fixture.py`; change data there, never by hand in the workbook.

Hardening levers for round 6 (if v6 is still 4-5/5):
...
Easing levers for round 6 (if v6 is 0/5):
