...
TRAPS = [
 ...
 ("PS-31", [LOGQ, CALLQ, DEFQ], "PS-31 carries ED-25 (-8 proposed; 'Cut, but six lines only.', then 'As Ines had it.': accepted at -6) and ED-42 (+2), whose only decision is 'Ditto.' on the line after 'Leave it with the author.' on ED-38: the same kind of call, so ED-42 stands deferred and PS-31 is recorded as carrying a deferred edit: {g}. A run that reads 'Ditto.' as an acceptance adds 2 lines and records a geometric verdict."),
 ("PS-34", [LOGQ, ACCQ, SAMEQ], "PS-34's only edit, ED-28 (+2), was parked by Ines ('Leave it with the author.') and accepted by Tomas at the number it stood ('Take it, at the number Ines had.'); it stands accepted at +2: {g}. A run that leaves it parked records EDIT_DEFERRED."),
]
